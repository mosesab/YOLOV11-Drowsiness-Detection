...
Here, In the Awake dataset, An open mouth detected is most likely a laugh or someone talking and not a yawn,
so open mouth detected is removed from the features used for sorting and only open or closed eyes is used.
...
if __name__ == "__main__":
    input_dir=r'/storage/emulated/0/python/DrowsyDetection/TrainingDatasetImages/Awake'
    output_dir=r'/storage/emulated/0/python/DrowsyDetection/SortedAwake'
    ...
    file_handler = logging.FileHandler(os.path.join(output_dir, 'sort_images_by_features_awake.log'), mode='w')
